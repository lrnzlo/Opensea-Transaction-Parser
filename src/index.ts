...
export async function GetABI(EtherscanAPIKEY: string, ContractAddress: string) {
  try {
...
// GetTransactionData('0xa52ca3611ad3ea1aa566dd605e24c25b6bc601eabf0969076eebc85df644a1d8', process.env.EtherscanApiKey)
//   .then(
//     TrxData => {
//       DecodeTransactionInfo(TrxData)
//         .then(res => {
//           console.log(res);
//         });
//     }
